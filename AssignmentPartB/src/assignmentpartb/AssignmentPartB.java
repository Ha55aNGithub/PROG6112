...
public class AssignmentPartB {
    ...
    public static void main(String[] args) {
        ...
        welcomeMsg();//always neat and tidy
    }
...
//make sure team is actuallyu mid table 
        if (input >= 8 && input <= 12) {
            menu();
...
//bunch of words. we dont mean it. we just want money.
        System.out.println("----------------------------------------------------------------");
...
// initially added as array was not printing but all works now, added failsafe if user tries to search for players befpre hand
